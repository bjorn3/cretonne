...
pub fn define(shared: &mut SharedDefinitions, x86_instructions: &InstructionGroup) {
    ...
    .isa("x86")
    .chain_with(shared.legalize_groups.by_name("expand_flags").id);
    ...
    let imm64_0x7777777777777777 = Literal::constant(imm64, 0x7777777777777777);
    #[allow(non_snake_case)]
    let imm64_0x0F0F0F0F0F0F0F0F = Literal::constant(imm64, 0x0F0F0F0F0F0F0F0F);
    let imm64_0x0101010101010101 = Literal::constant(imm64, 0x0101010101010101);
    let imm64_1 = Literal::constant(imm64, 1);
    let imm64_4 = Literal::constant(imm64, 4);
    let imm64_56 = Literal::constant(imm64, 56);
    group.legalize(
        def!(qv16 = popcnt.I64(qv1)),
        vec![
            def!(qv3 = ushr_imm(qv1, imm64_1)),
            def!(qc77 = iconst(imm64_0x7777777777777777)),
            ...
            def!(qc0F = iconst(imm64_0x0F0F0F0F0F0F0F0F)),
            def!(qv14 = band(qv13, qc0F)),
            def!(qc01 = iconst(imm64_0x0101010101010101)),
            def!(qv15 = imul(qv14, qc01)),
            def!(qv16 = ushr_imm(qv15, imm64_56)),
        ],
    );
    ...
    group.legalize(
        ...
        vec![
            ...
            def!(lc0F = iconst(imm64_0x0F0F0F0F)),
            def!(lv14 = band(lv13, lc0F)),
            def!(lc01 = iconst(imm64_0x01010101)),
            def!(lv15 = imul(lv14, lc01)),
            def!(lv16 = ushr_imm(lv15, imm64_24)),
        ],
    );

    group.finish_and_add_to(&mut shared.legalize_groups);
}
