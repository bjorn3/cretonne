...
use crate::cdsl::xform::{XFormGroupBuilder, XFormGroups};
...
pub fn define(insts: &InstructionGroup, immediates: &OperandKinds) -> XFormGroups {
    let mut narrow = XFormGroupBuilder::new(
        "narrow",
        r#"
    ...
    let mut widen = XFormGroupBuilder::new(
        "widen",
        r#"
    ...
    let mut expand = XFormGroupBuilder::new(
        "expand",
        r#"
    ...
    expand.custom_legalize(insts.by_name("trapz"), "expand_cond_trap");
    expand.custom_legalize(insts.by_name("trapnz"), "expand_cond_trap");
    expand.custom_legalize(insts.by_name("br_table"), "expand_br_table");
    expand.custom_legalize(insts.by_name("select"), "expand_select");
    ...
    for &extend_op in &[uextend, sextend] {
        ...
        // XXX Try to tie this more closely to the uextend/sextend definitions.
    ...
    for &int_ty in &[I8, I16] {
        ...
        for w_cc in &[
            ...
            Literal::enumerator_for(intcc, "ne"),
            Literal::enumerator_for(intcc, "ugt"),
            Literal::enumerator_for(intcc, "ult"),
            Literal::enumerator_for(intcc, "uge"),
            Literal::enumerator_for(intcc, "ule"),
        ] {
            widen.legalize(
        ...
        for w_cc in &[
            Literal::enumerator_for(intcc, "sgt"),
            Literal::enumerator_for(intcc, "slt"),
            Literal::enumerator_for(intcc, "sge"),
            Literal::enumerator_for(intcc, "sle"),
        ] {
            widen.legalize(
                def!(a = icmp_imm.int_ty(w_cc, b, c)),
    ...
    let imm64_0xaa = Literal::constant(imm64, 0xaa);
    let imm64_0x55 = Literal::constant(imm64, 0x55);
    let imm64_0xcc = Literal::constant(imm64, 0xcc);
    let imm64_0x33 = Literal::constant(imm64, 0x33);
    let imm64_0xf0 = Literal::constant(imm64, 0xf0);
    let imm64_0x0f = Literal::constant(imm64, 0x0f);

    widen.legalize(
        def!(a = bitrev.I8(x)),
        vec![
            def!(a1 = band_imm(x, imm64_0xaa)),
            def!(a2 = ushr_imm(a1, imm64_1)),
            def!(a3 = band_imm(x, imm64_0x55)),
            def!(a4 = ishl_imm(a3, imm64_1)),
            def!(b = bor(a2, a4)),
            def!(b1 = band_imm(b, imm64_0xcc)),
            def!(b2 = ushr_imm(b1, imm64_2)),
            def!(b3 = band_imm(b, imm64_0x33)),
            def!(b4 = ishl_imm(b3, imm64_2)),
            def!(c = bor(b2, b4)),
            def!(c1 = band_imm(c, imm64_0xf0)),
            def!(c2 = ushr_imm(c1, imm64_4)),
            def!(c3 = band_imm(c, imm64_0x0f)),
            def!(c4 = ishl_imm(c3, imm64_4)),
            def!(a = bor(c2, c4)),
        ],
    );

    let imm64_0xaaaa = Literal::constant(imm64, 0xaaaa);
    let imm64_0x5555 = Literal::constant(imm64, 0x5555);
    let imm64_0xcccc = Literal::constant(imm64, 0xcccc);
    let imm64_0x3333 = Literal::constant(imm64, 0x3333);
    let imm64_0xf0f0 = Literal::constant(imm64, 0xf0f0);
    let imm64_0x0f0f = Literal::constant(imm64, 0x0f0f);
    let imm64_0xff00 = Literal::constant(imm64, 0xff00);
    let imm64_0x00ff = Literal::constant(imm64, 0x00ff);
    let imm64_8 = Literal::constant(imm64, 8);

    widen.legalize(
        def!(a = bitrev.I16(x)),
        vec![
            def!(a1 = band_imm(x, imm64_0xaaaa)),
            def!(a2 = ushr_imm(a1, imm64_1)),
            def!(a3 = band_imm(x, imm64_0x5555)),
            def!(a4 = ishl_imm(a3, imm64_1)),
            def!(b = bor(a2, a4)),
            def!(b1 = band_imm(b, imm64_0xcccc)),
            def!(b2 = ushr_imm(b1, imm64_2)),
            def!(b3 = band_imm(b, imm64_0x3333)),
            def!(b4 = ishl_imm(b3, imm64_2)),
            def!(c = bor(b2, b4)),
            def!(c1 = band_imm(c, imm64_0xf0f0)),
            def!(c2 = ushr_imm(c1, imm64_4)),
            def!(c3 = band_imm(c, imm64_0x0f0f)),
            def!(c4 = ishl_imm(c3, imm64_4)),
            def!(d = bor(c2, c4)),
            def!(d1 = band_imm(d, imm64_0xff00)),
            def!(d2 = ushr_imm(d1, imm64_8)),
            def!(d3 = band_imm(d, imm64_0x00ff)),
            def!(d4 = ishl_imm(d3, imm64_8)),
            def!(a = bor(d2, d4)),
        ],
    );

    let imm64_0xaaaaaaaa = Literal::constant(imm64, 0xaaaaaaaa);
    let imm64_0x55555555 = Literal::constant(imm64, 0x55555555);
    let imm64_0xcccccccc = Literal::constant(imm64, 0xcccccccc);
    let imm64_0x33333333 = Literal::constant(imm64, 0x33333333);
    let imm64_0xf0f0f0f0 = Literal::constant(imm64, 0xf0f0f0f0);
    let imm64_0x0f0f0f0f = Literal::constant(imm64, 0x0f0f0f0f);
    let imm64_0xff00ff00 = Literal::constant(imm64, 0xff00ff00);
    let imm64_0x00ff00ff = Literal::constant(imm64, 0x00ff00ff);
    let imm64_16 = Literal::constant(imm64, 16);

    expand.legalize(
        def!(a = bitrev.I32(x)),
        vec![
            def!(a1 = band_imm(x, imm64_0xaaaaaaaa)),
            def!(a2 = ushr_imm(a1, imm64_1)),
            def!(a3 = band_imm(x, imm64_0x55555555)),
            def!(a4 = ishl_imm(a3, imm64_1)),
            def!(b = bor(a2, a4)),
            def!(b1 = band_imm(b, imm64_0xcccccccc)),
            def!(b2 = ushr_imm(b1, imm64_2)),
            def!(b3 = band_imm(b, imm64_0x33333333)),
            def!(b4 = ishl_imm(b3, imm64_2)),
            def!(c = bor(b2, b4)),
            def!(c1 = band_imm(c, imm64_0xf0f0f0f0)),
            def!(c2 = ushr_imm(c1, imm64_4)),
            def!(c3 = band_imm(c, imm64_0x0f0f0f0f)),
            def!(c4 = ishl_imm(c3, imm64_4)),
            def!(d = bor(c2, c4)),
            def!(d1 = band_imm(d, imm64_0xff00ff00)),
            def!(d2 = ushr_imm(d1, imm64_8)),
            def!(d3 = band_imm(d, imm64_0x00ff00ff)),
            def!(d4 = ishl_imm(d3, imm64_8)),
            def!(e = bor(d2, d4)),
